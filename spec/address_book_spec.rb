  ...
  let (:book) {AddressBook.new}
   ...
   describe "importing from entries_2.csv" do 
    ...
    it "imports the correct number of entries" do
     ...
     it "imports the 1st entry" do
       ...
       entry_one = book.entries[0]
       check_entry(entry_one, "Alex", "555-555-5415", "Alex@blocmail.com")
     end
      ...
      it "imports the 2nd entry" do
       ...
       entry_two = book.entries[1]
       check_entry(entry_two, "Gav","555-555-4854" ,"Gav@blocmail.com" )
     end
   ...
   describe "#binary_search" do
    ...
    it "searches AddressBook for Bill" do
       ...
       #Aliyar: Is this the class Entry that we have in add_book.rb?
    ...
    it "searches AddressBook for Bob" do
     ...
     it "searches AddressBook for Sussie" do
       ...
       # Note: This Billy is not exactly the same to the other Billy 
